...
const Header = () => {
    ...
    useEffect(() => {
        switch (isTheme.theme) {
            case THEME_LIGHT: setIcon(imgAvengers); break;
            case THEME_DARK: setIcon(imgThanos); break;
            case THEME_NEUTRAL: setIcon(imgDeadpool); break;
            default: setIcon(imgAvengers);
        }
    }, [isTheme])
